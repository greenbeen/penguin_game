...
def add_L(space):
    ...
    line1 = pymunk.Segment(body2, (-200, 0), (-200, 0), 10.0)
    ...
    space.add(l1, l2, line1) #, body, rotation_center_joint, rotation_limit_joint)
    return l1,l2, line1
...
def draw_lines(screen, lines):
    ...
    for line in lines:
        ...
        p1 = to_pygame(line.a + body.position)
        p2 = to_pygame(line.b + body.position)
